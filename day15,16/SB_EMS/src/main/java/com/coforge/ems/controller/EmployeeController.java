...
public class EmployeeController {
	...
	public ResponseEntity<String> updateEmployee( @Valid @PathVariable("eid") int eid, @Valid @RequestBody Employee employee) {
		ResponseEntity<String> responseEntity = null;
	...
	public ResponseEntity<?> findByEid(@Valid @PathVariable("eid") int eid) {
